...
> **文档版本**: v2.2 | **日期**: 2026-07-23 | **作者**: AI PM（v2.2: 签约后账期自动插入规则+billing_cycle/payment_term必填改条件；v2.1: contract_start_date+end_date改为条件必填）
> **上游文档**: `2026-07-23-用户需求.md`
...
### 表11b: `supplier_contract` | 对应实体: 供应商合同 (SupplierContract) — 一期新增
...
- **逻辑删除 `supplier` 时**: 同步软删除 supplier_contact, supplier_print_service, supplier_material, supplier_contract
