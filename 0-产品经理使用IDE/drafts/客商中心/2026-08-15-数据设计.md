...
> **文档版本**: v2.3 | **日期**: 2026-08-15 | **作者**: AI PM（v2.3: 移除打单服务实体+supplier_print_service表，供应商改左右结构3Tab；v2.2: 签约后账期自动插入规则+billing_cycle/payment_term必填改条件；v2.1: contract_start_date+end_date改为条件必填）
> **上游文档**: `2026-08-15-用户需求.md`
...
| `contract_start_date` | 合同开始日期 | Date | 条件 | — | 除简易标准合同外均必填，默认当天 |
| `contract_end_date` | 合同结束日期 | Date | 条件 | — | 除简易标准合同外均必填，自动计算 |
