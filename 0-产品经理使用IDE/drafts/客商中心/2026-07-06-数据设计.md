...
> **文档版本**: v2.1 | **日期**: 2026-07-06 | **作者**: AI PM（v2.1: contract_start_date+end_date改为条件必填；v2.0: sign_date签订日期改为条件必填；v1.9: supplier_contract移除is_new_customer+old_customer_code字段）
> **上游文档**: `2026-07-06-用户需求.md`
