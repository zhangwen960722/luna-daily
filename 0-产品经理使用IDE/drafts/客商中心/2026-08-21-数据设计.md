...
>
> **签约后账期自动插入**：签约完成（sign_status=已签署）时系统自动填充账期段——大陆+标准合同：payment_term=签约所选，billing_cycle/settlement_type/settlement_month 级联推导，days_or_date=0；大陆+非标准合同 / 中国香港：仅填 contract_company，其余账期字段留空待销售补填。
...
| `days_or_date` | 天数/号 | Int | — | — | >=0 整数；大陆+标准合同默认 0，其余场景留空 |
