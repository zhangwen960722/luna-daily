...
> **文档版本**: v1.7 | **日期**: 2026-06-22 | **作者**: AI PM（v1.7: customer_contract新增is_new_customer+old_customer_code签约字段；v1.6: customer_contract新增is_primary主合同标记+termination_date解约时间+sign_status新增50:已解约；v1.5: customer表新增sales_assistant字段；v1.4: 合同1:1→1:N多主体签约）
