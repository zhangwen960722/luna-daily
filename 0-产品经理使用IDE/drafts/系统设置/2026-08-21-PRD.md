...
- **版本号**：v3.2
- **状态**：草稿
- **作者**：AI PM（v3.2: 签约简易+非标合同分支开始/结束日期自动推导；v3.1: 合同签约对齐客商中心/邮件通知模板更新/合同1:1→1:N/全文档英文字段转中文）
- **评审人**：产品/研发/测试/业务代表
- **计划里程碑**：评审 2026-06-10 / 提测 2026-06-30 / 上线 2026-07-15

**0.1 关联链接**

- 用户需求(RDD)：`drafts/系统设置/2026-08-21-用户需求.md` v3.2
- 数据设计：`drafts/系统设置/2026-08-21-数据设计.md` v3.2
- 需求背景：无（0-1新建模块）
...
| 是 | 否 | 合同有效期限(Select:1/2/3年) + 签订日期(Date:默认当天) + 合同修改内容(Textarea) + 附件上传（开始/结束日期由签订日期+期限自动推导） |
