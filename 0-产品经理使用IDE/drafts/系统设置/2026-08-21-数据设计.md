...
> **版本**: v3.2 | **日期**: 2026-08-21 | **作者**: AI PM
> **关联文档**: `2026-08-21-产品文档.md` v3.2
...
| `contract_start_date` | 合同开始日期 | Date | No | — | 非简易合同时必填，默认当天；简易合同由签订日期自动推导 |
| `contract_end_date` | 合同结束日期 | Date | No | — | 非简易合同时必填，自动计算；简易合同=签订日期+期限-1天 |
...
| `body` | 邮件内容 | Text | Yes | — | 含虚拟账号和初始密码的完整邮件正文，模板详见产品文档 §3.5 |
...
> 见产品文档 R1.7（审核通过）、R1.21（邮件通知）、R1.22（客户管理数据同步）。
