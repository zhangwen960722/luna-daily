...
- 用户需求(RDD)：`drafts/头程管理/2026-09-18-用户需求.md` (v2.4)
- 数据设计：`drafts/头程管理/2026-09-18-数据设计.md` (v2.4)
- 需求背景：待补充
- 原型：待更新
...
- 术语表：
  ...
  - **运单 (Waybill)**：物流运输单据
- 原型链接：见 0.2 关联链接
- 用户需求(RDD)（完整业务流程+字段表）：`drafts/头程管理/2026-09-18-用户需求.md`
- 数据设计（完整 Schema+ER 图）：`drafts/头程管理/2026-09-18-数据设计.md`
