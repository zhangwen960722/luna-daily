...
> **上游文档**: `2026-06-16-产品文档.md`（v3.0，邀请触达 + 系统自动尽调）
...
### 触发机制
- 客户提交 `enterprise_profile`（status=20 待审核）后，系统自动创建聚合根 `due_diligence_log`，再调用天眼查 API 填充 `enterprise_info` 与 `enterprise_risk_report`
...
### 降级策略
- 见产品文档 R3.1、R3.6（天眼查失败降级提示 + 定时补采）
